...
class CheckpointableDict(object):
    ...
    def load_state_dict(self, dict_data):
...
class PeriodicCheckpointer:
    ...
    def step_by_epoch(self, epoch: int, **kwargs: Any) -> None:
        """
        Perform the appropriate action at the given epoch.
        ...
        additional_state.update(kwargs)
        self.checkpointer.save(
            "{}_epoch_{:07d}".format(self.file_prefix, epoch), **additional_state
        )
